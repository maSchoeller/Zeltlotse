...
<#
    ...
    PostgreSQL, Schnittstelle und Oberfläche gemeinsam hoch.
#>
[CmdletBinding()]
param()
...
try {
    ...
    Write-Error 'Docker läuft nicht. Der AppHost startet PostgreSQL als Container — bitte Docker Desktop starten.'
    exit 1
}
